		...
		case WM_VSCROLL:
			...
			if (pTC) {
				switch(LOWORD(wParam)){
					...
					case SB_PAGEUP:		pTC->m_si.nPos -= pTC->m_si.nMax / pTC->m_si.nPage; break;
					case SB_PAGEDOWN:	pTC->m_si.nPos += pTC->m_si.nMax / pTC->m_si.nPage; break;

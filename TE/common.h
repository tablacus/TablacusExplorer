...
#ifndef WININET_E_CANNOT_CONNECT
...
#define E_BAD_NET_NAME		HRESULT_FROM_WIN32(ERROR_BAD_NET_NAME)
#define E_INVALID_PASSWORD  HRESULT_FROM_WIN32(ERROR_INVALID_PASSWORD)
#define E_LOGON_FAILURE		HRESULT_FROM_WIN32(ERROR_LOGON_FAILURE)
